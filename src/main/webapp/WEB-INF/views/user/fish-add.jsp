      ...
      <div class="container-fluid">
        <div class="mx-lg-1" style="width: 500px; padding-top: 20px">
          <form:form method="post" modelAttribute="fish">
            <div class="mb-3">
              <label for="fishName" class="form-label" >Nazwa</label>
              <form:select class="form-select" path="fishName" items="${fishNames}" itemLabel="name" itemValue="id" />
              <label for="weight" class="form-label" >Waga</label>
              <form:input class="form-control" path="weight" type="number" min="0" max="9999" step="0.1"/>
              <label for="length" class="form-label" >Długość</label>
              <form:input class="form-control" path="length" type="number" min="0" max="999" step="0.1"/>
              <form:input path="fishingSession" type="hidden" value="${fishingSession}"/>
            </div>
            <form:button type="submit" class="btn btn-primary">Dodaj</form:button>
          </form:form>
        </div>
      </div>
    </main>
